  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Button asChild variant="outline">
            <Link href="/officer/requests">{TH.action.back}</Link>
          </Button>
        }
      />
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2">
        ...
        {["draft", "submitted"].includes(request.status) && !request.assigned_to ? (
          <Button asChild variant="outline" className="gap-2">
            <Link href={`/officer/requests/${id}/edit`}>
        ...
        <OfficerRequestActions
          ...
          assigned={Boolean(request.assigned_to)}
        />
      </div>
